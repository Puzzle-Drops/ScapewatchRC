class FiremakingSkill extends BaseSkill {
    ...
    initializeSkillData() {
        this.SKILL_DATA = [
            { itemId: 'logs',         name: 'Logs',         minCount: 40, maxCount: 80, level: 1  },
            { itemId: 'oak_logs',     name: 'Oak logs',     minCount: 40, maxCount: 80, level: 15 },
            { itemId: 'willow_logs',  name: 'Willow logs',  minCount: 40, maxCount: 80, level: 30 },
            { itemId: 'maple_logs',   name: 'Maple logs',   minCount: 40, maxCount: 80, level: 45 },
            { itemId: 'yew_logs',     name: 'Yew logs',     minCount: 40, maxCount: 80, level: 60 },
            { itemId: 'magic_logs',   name: 'Magic logs',   minCount: 40, maxCount: 80, level: 75 },
            { itemId: 'redwood_logs', name: 'Redwood logs', minCount: 40, maxCount: 80, level: 90 }
        ];
    }
